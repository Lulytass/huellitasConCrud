...
<html lang="en" title="Coding design">
    ...
    <head>
        ...
        <title>Ver articulo de Huellitas</title>
        ...
        <table id="dataTable">
            ...
            <tbody>
                <?php
                    ...
                    $registro = $mysqli->query("SELECT * FROM ArtPerroGato WHERE id = $id;");
                    ...
                    echo '<td> <a class="eliminar" href="/admin/eliminarArticulo.php/?id='.$resultado->id.'"> Eliminar articulo </a> </td> <br>';
                    echo '</tr>';
